        ...
        1: [function(e, t, r) {
            ...
            function d(e, t, r, n) {
                ...
                i.track = t, i.receiver = r, i.transceiver = {
                    receiver: r
                }, i.streams = n, window.setTimeout(function() {
            ...
            t.exports = function(e, t) {
                var r = function(r) {
                    ...
                    if (r.iceServers = function(e, t) {
                        ...
                        for (var o = r.iceCandidatePoolSize; o > 0; o--) this._iceGatherers = new e.RTCIceGatherer({
                ...
                r.prototype.onicecandidate = null, r.prototype.onaddstream = null, r.prototype.ontrack = null, r.prototype.onremovestream = null, r.prototype.onsignalingstatechange = null, r.prototype.oniceconnectionstatechange = null, r.prototype.onicegatheringstatechange = null, r.prototype.onnegotiationneeded = null, r.prototype.ondatachannel = null, r.prototype._dispatchEvent = function(e, t) {
                    ...
                    if ("closed" === this.signalingState) throw p("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
                    ...
                    if (!r) throw p("InvalidAccessError", "Sender was not created by this connection.");
                    var n = r.stream;
                    ...
                    return Object.defineProperty(i, "state", {
                        ...
                        i.state = r ? "completed" : "gathering", null !== n.transceivers[t].candidates && n.transceivers[t].candidates.push(e.candidate)
                    ...
                    if (!a.onlocalcandidate) {
                        var o = this.transceivers[r].candidates;
                        this.transceivers[r].candidates = null, a.removeEventListener("localcandidate", this.transceivers[r].bufferCandidates), a.onlocalcandidate = function(e) {
                            if (!(i.usingBundle && r > 0)) {
                                ...
                                c ? "new" !== a.state && "gathering" !== a.state || (a.state = "completed") : ("new" === a.state && (a.state = "gathering"), s.component = 1, o.candidate.candidate = n.writeCandidate(s));
                                var d = n.splitSections(i.localDescription.sdp);
                                d[o.candidate.sdpMLineIndex + 1] += c ? "a=end-of-candidates\r\n" : "a=" + o.candidate.candidate + "\r\n", i.localDescription.sdp = d.join("");
                                var p = i.transceivers.every(function(e) {
                                    return e.iceGatherer && "completed" === e.iceGatherer.state
                                });
                                "gathering" !== i.iceGatheringState && (i.iceGatheringState = "gathering", i._emitGatheringStateChange()), c || i._dispatchEvent("icecandidate", o), p && (i._dispatchEvent("icecandidate", new Event("icecandidate")), i.iceGatheringState = "complete", i._emitGatheringStateChange())
                            }
                        }, e.setTimeout(function() {
                            o.forEach(function(e) {
                                var t = new Event("RTCIceGatherEvent");
                                t.candidate = e, a.onlocalcandidate(t)
                            })
                        }, 0)
                    }
                ...
                }, r.prototype._transceive = function(e, r, i) {
                    ...
                    var t, r, i = this;
                    if (!o("setLocalDescription", e.type, this.signalingState) || this._isClosed) return Promise.reject(p("InvalidStateError", "Can not set local " + e.type + " in state " + i.signalingState));
                    if ("offer" === e.type) t = n.splitSections(e.sdp), r = t.shift(), t.forEach(function(e, t) {
                        ...
                        t = n.splitSections(i.remoteDescription.sdp), r = t.shift();
                        ...
                        t.forEach(function(e, t) {
                            ...
                            if (!(n.isRejected(e) && 0 === n.matchPrefix(e, "a=bundle-only").length) && !o.isDatachannel) {
                    ...
                    var i = this;
                    if (!o("setRemoteDescription", r.type, this.signalingState) || this._isClosed) return Promise.reject(p("InvalidStateError", "Can not set remote " + r.type + " in state " + i.signalingState));
                    var a = {};
                    this.remoteStreams.forEach(function(e) {
                        a[e.id] = e
                    });
                    var u = [],
                        f = n.splitSections(r.sdp),
                        l = f.shift(),
                        m = n.matchPrefix(l, "a=ice-lite").length > 0,
                        h = n.matchPrefix(l, "a=group:BUNDLE ").length > 0;
                    this.usingBundle = h;
                    var v = n.matchPrefix(l, "a=ice-options:")[0];
                    switch (this.canTrickleIceCandidates = !!v && v.substr(14).split(" ").indexOf("trickle") >= 0, f.forEach(function(o, d) {
                        var p = n.splitLines(o),
                            f = n.getKind(o),
                            v = n.isRejected(o) && 0 === n.matchPrefix(o, "a=bundle-only").length,
                            g = p[0].substr(2).split(" ")[2],
                            y = n.getDirection(o, l),
                            C = n.parseMsid(o),
                            T = n.getMid(o) || n.generateIdentifier();
                        if ("application" !== f || "DTLS/SCTP" !== g) {
                            var S, R, P, b, E, k, w, _, x, O, D, M = n.parseRtpParameters(o);
                            v || (O = n.getIceParameters(o, l), (D = n.getDtlsParameters(o, l)).role = "client"), w = n.parseRtpEncodingParameters(o);
                            var L = n.parseRtcpParameters(o),
                                I = n.matchPrefix(o, "a=end-of-candidates", l).length > 0,
                                j = n.matchPrefix(o, "a=candidate:").map(function(e) {
                            ...
                            if (("offer" === r.type || "answer" === r.type) && !v && h && d > 0 && i.transceivers[d] && (i._disposeIceAndDtlsTransports(d), i.transceivers[d].iceGatherer = i.transceivers[0].iceGatherer, i.transceivers[d].iceTransport = i.transceivers[0].iceTransport, i.transceivers[d].dtlsTransport = i.transceivers[0].dtlsTransport, i.transceivers[d].rtpSender && i.transceivers[d].rtpSender.setTransport(i.transceivers[0].dtlsTransport), i.transceivers[d].rtpReceiver && i.transceivers[d].rtpReceiver.setTransport(i.transceivers[0].dtlsTransport)), "offer" !== r.type || v) "answer" !== r.type || v || (R = (S = i.transceivers[d]).iceGatherer, P = S.iceTransport, b = S.dtlsTransport, E = S.rtpReceiver, k = S.sendEncodingParameters, _ = S.localCapabilities, i.transceivers[d].recvEncodingParameters = w, i.transceivers[d].remoteCapabilities = M, i.transceivers[d].rtcpParameters = L, j.length && "new" === P.state && (!m && !I || h && 0 !== d ? j.forEach(function(e) {
                                s(S.iceTransport, e)
                            }) : P.setRemoteCandidates(j)), h && 0 !== d || ("new" === P.state && P.start(R, O, "controlling"), "new" === b.state && b.start(D)), i._transceive(S, "sendrecv" === y || "recvonly" === y, "sendrecv" === y || "sendonly" === y), !E || "sendrecv" !== y && "sendonly" !== y ? delete S.rtpReceiver : (x = E.track, C ? (a[C.stream] || (a[C.stream] = new e.MediaStream), c(x, a[C.stream]), u.push([x, E, a[C.stream]])) : (a.default || (a.default = new e.MediaStream), c(x, a.default), u.push([x, E, a.default]))));
                            else {
                                (S = i.transceivers[d] || i._createTransceiver(f)).mid = T, S.iceGatherer || (S.iceGatherer = i._createIceGatherer(d, h)), j.length && "new" === S.iceTransport.state && (!I || h && 0 !== d ? j.forEach(function(e) {
                                    s(S.iceTransport, e)
                                }) : S.iceTransport.setRemoteCandidates(j)), _ = e.RTCRtpReceiver.getCapabilities(f), t < 15019 && (_.codecs = _.codecs.filter(function(e) {
                                    return "rtx" !== e.name
                                })), k = S.sendEncodingParameters || [{
                                    ssrc: 1001 * (2 * d + 2)
                                }];
                                var N, U = !1;
                                if ("sendrecv" === y || "sendonly" === y) {
                                    if (U = !S.rtpReceiver, E = S.rtpReceiver || new e.RTCRtpReceiver(S.dtlsTransport, f), U) x = E.track, C && "-" === C.stream || (C ? (a[C.stream] || (a[C.stream] = new e.MediaStream, Object.defineProperty(a[C.stream], "id", {
                                        get: function() {
                                            return C.stream
                                        }
                                    ...
                                    }), N = a[C.stream]) : (a.default || (a.default = new e.MediaStream), N = a.default)), N && (c(x, N), S.associatedRemoteMediaStreams.push(N)), u.push([x, E, N])
                                    ...
                                    t && function(e, t) {
                                        t.removeTrack(e);
                                        var r = new Event("removetrack");
                                        r.track = e, t.dispatchEvent(r)
                                    }(t, e)
                                }), S.associatedRemoteMediaStreams = []);
                                S.localCapabilities = _, S.remoteCapabilities = M, S.rtpReceiver = E, S.rtcpParameters = L, S.sendEncodingParameters = k, S.recvEncodingParameters = w, i._transceive(i.transceivers[d], !1, U)
                            }
                        } else i.transceivers[d] = {
                            mid: T,
                            isDatachannel: !0
                        }
                    }), void 0 === this._dtlsRole && (this._dtlsRole = "offer" === r.type ? "active" : "passive"), this.remoteDescription = {
                        type: r.type,
                        sdp: r.sdp
                    }, r.type) {
                        case "offer":
                    ...
                    var r = this;
                    if (this._isClosed) return Promise.reject(p("InvalidStateError", "Can not call createOffer after close"));
                    var a = this.transceivers.filter(function(e) {
                            return "audio" === e.kind
                        }).length,
                        o = this.transceivers.filter(function(e) {
                            return "video" === e.kind
                        }).length,
                        s = arguments[0];
                    if (s) {
                    ...
                    var c = n.writeSessionBoilerplate(this._sdpSessionId, this._sdpSessionVersion++);
                    this.transceivers.forEach(function(i, a) {
                        var o = i.track,
                            s = i.kind,
                            c = n.generateIdentifier();
                    ...
                    var r = this;
                    if (this._isClosed) return Promise.reject(p("InvalidStateError", "Can not call createAnswer after close"));
                    var o = n.writeSessionBoilerplate(this._sdpSessionId, this._sdpSessionVersion++);
                    this.usingBundle && (o += "a=group:BUNDLE " + this.transceivers.map(function(e) {
                        return e.mid
                    }).join(" ") + "\r\n");
                    var s = n.splitSections(this.remoteDescription.sdp).length - 1;
                    this.transceivers.forEach(function(e, n) {
                        if (!(n + 1 > s))
                            if (e.isDatachannel) o += "m=application 0 DTLS/SCTP 5000\r\nc=IN IP4 0.0.0.0\r\na=mid:" + e.mid + "\r\n";
                            else {
                                var c;
                    ...
                    if (e && "" !== e.candidate) {
                        ...
                        if (!this.remoteDescription) return Promise.reject(p("InvalidStateError", "Can not add ICE candidate without a remote description"));
                        ...
                        if (!a) return Promise.reject(p("OperationError", "Can not add ICE candidate"));
                        ...
                        if ((0 === r || r > 0 && a.iceTransport !== this.transceivers[0].iceTransport) && !s(a.iceTransport, o)) return Promise.reject(p("OperationError", "Can not add ICE candidate"));
                        var c = e.candidate.trim();
                        0 === c.indexOf("a=") && (c = c.substr(2)), (t = n.splitSections(this.remoteDescription.sdp))[r + 1] += "a=" + (o.type ? c : "end-of-candidates") + "\r\n", this.remoteDescription.sdp = t.join("")
                    } else
                        for (var d = 0; d < this.transceivers.length && (this.transceivers[d].isDatachannel || (this.transceivers[d].iceTransport.addRemoteCandidate({}), (t = n.splitSections(this.remoteDescription.sdp))[d + 1] += "a=end-of-candidates\r\n", this.remoteDescription.sdp = t.join(""), !this.usingBundle)); d++);
                    return Promise.resolve()
            ...
            t.exports = function(t, r) {
                ...
                switch (c.browser) {
                    case "chrome":
                        ...
                        s("adapter.js shimming chrome."), m.browserShim = d, l.shimCreateObjectURL(i), d.shimGetUserMedia(i), d.shimMediaStream(i), d.shimSourceObject(i), d.shimPeerConnection(i), d.shimOnTrack(i), d.shimAddTrackRemoveTrack(i), d.shimGetSendersWithDtmf(i), l.shimRTCIceCandidate(i), l.shimMaxMessageSize(i), l.shimSendThrowTypeError(i);
                        break;
                    case "firefox":
                        if (!u || !u.shimPeerConnection || !a.shimFirefox) return s("Firefox shim is not included in this adapter release."), m;
                        s("adapter.js shimming firefox."), m.browserShim = u, l.shimCreateObjectURL(i), u.shimGetUserMedia(i), u.shimSourceObject(i), u.shimPeerConnection(i), u.shimOnTrack(i), u.shimRemoveStream(i), l.shimRTCIceCandidate(i), l.shimMaxMessageSize(i), l.shimSendThrowTypeError(i);
                        break;
                    case "edge":
                        if (!p || !p.shimPeerConnection || !a.shimEdge) return s("MS edge shim is not included in this adapter release."), m;
                        s("adapter.js shimming edge."), m.browserShim = p, l.shimCreateObjectURL(i), p.shimGetUserMedia(i), p.shimPeerConnection(i), p.shimReplaceTrack(i), l.shimMaxMessageSize(i), l.shimSendThrowTypeError(i);
                        break;
                    case "safari":
                ...
                var t = n.detectBrowser(e),
                    ...
                    o = function(e, n) {
                        ...
                        if (e && "object" == typeof e.video) {
                            ...
                            if (s && ("user" === s.exact || "environment" === s.exact || "user" === s.ideal || "environment" === s.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || d))
            ...
            t.exports = {
                ...
                shimMaxMessageSize: function(e) {
                    if (!e.RTCSctpTransport && e.RTCPeerConnection) {
                        ...
                        e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                            var e, i, a, o;
                            if (this._sctp = null, a = arguments[0], (o = n.splitSections(a.sdp)).shift(), o.some(function(e) {
                                ...
                                var s, c = function(e) {
                                    ...
                                    d = (e = c, i = 65536, "firefox" === t.browser && (i = t.version < 57 ? -1 === e ? 16384 : 2147483637 : 57 === t.version ? 65535 : 65536), i),
                                    p = function(e, r) {
                                        var i = 65536;
                                        "firefox" === t.browser && 57 === t.version && (i = 65535);
                                        var a = n.matchPrefix(e.sdp, "a=max-message-size:");
                                        return a.length > 0 ? i = parseInt(a[0].substr(19), 10) : "firefox" === t.browser && -1 !== r && (i = 2147483637), i
                                    }(arguments[0], c);
                                s = 0 === d && 0 === p ? Number.POSITIVE_INFINITY : 0 === d || 0 === p ? Math.max(d, p) : Math.min(d, p);
                                var u = {};
            ...
            t.exports = function(e) {
                ...
                if (!(t.version > 55 && "autoGainControl" in r.mediaDevices.getSupportedConstraints())) {
                    ...
                    if (r.mediaDevices.getUserMedia = function(e) {
                            return "object" == typeof e && "object" == typeof e.audio && (e = JSON.parse(JSON.stringify(e)), p(e.audio, "autoGainControl", "mozAutoGainControl"), p(e.audio, "noiseSuppression", "mozNoiseSuppression")), u(e)
                    ...
                    if (a && a.prototype.applyConstraints) {
                        ...
                        a.prototype.applyConstraints = function(e) {
                            return "audio" === this.kind && "object" == typeof e && (e = JSON.parse(JSON.stringify(e)), p(e, "autoGainControl", "mozAutoGainControl"), p(e, "noiseSuppression", "mozNoiseSuppression")), l.apply(this, [e])
                        }
                    }
                }
                ...
                shimCreateOfferLegacy: function(e) {
                    ...
                    e.RTCPeerConnection.prototype.createOffer = function(e) {
                        ...
                        if (e) {
                            ...
                            !1 === e.offerToReceiveAudio && n ? "sendrecv" === n.direction ? n.setDirection ? n.setDirection("sendonly") : n.direction = "sendonly" : "recvonly" === n.direction && (n.setDirection ? n.setDirection("inactive") : n.direction = "inactive") : !0 !== e.offerToReceiveAudio || n || r.addTransceiver("audio");
